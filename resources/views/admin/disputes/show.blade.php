        ...
        <div class="p-5 sm:p-6" x-show="tab === 'documents'" x-cloak>
            <div class="space-y-2">
                @forelse ($deal->documents as $doc)
                    <div class="flex items-center gap-3 rounded-2xl bg-surface px-4 py-3.5">
                        ...
                        <a href="{{ route('admin.documents.download', $doc) }}" class="btn-ghost shrink-0 px-3 py-2 text-xs">Скачать</a>
                    </div>
                @empty
